...
public class EditarJuegoDialogo extends AppCompatDialogFragment {
    ...
    public static EditarJuegoDialogo newInstance(JuegoFragment p, String id, String nombre, String descripcion, String nVentas, String urlFoto ) {
        ...
        args.putString(ARGUMENTO_ID_PUEBLO, id);  //pasamos el id del pueblo
