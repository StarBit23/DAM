 ...
 * me genere una contraseña encriptada. Utilizo los datos username = jorge y password=jorge
 * 
 * Generaremos una llamada a nuestro endpoint auth, donde con el método post le pasaremos
 * nuestro usuario y contraseña que mandamos desde un login. Probamos con username = "jorge" y
 * password="jorge". Lo que nos deberá generar es un token y lo devolerá para que lo siguamos utilizando
