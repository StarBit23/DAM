...
import com.example.listaspersonalizadas.adaptadores.AdaptadorPueblos;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        Necesitamos un Adapter que toma el contexto del Activity, el xml del diseño de cada elemento (CardView)
        y la lista de los Pueblos.  Ahora necesitamos un Adaptador personalizado y un diseño xml para un pueblo personalizado.
         */
