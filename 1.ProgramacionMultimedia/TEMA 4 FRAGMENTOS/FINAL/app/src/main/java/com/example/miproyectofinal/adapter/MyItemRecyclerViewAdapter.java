...
public class MyItemRecyclerViewAdapter extends RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewJuego> {
    ...
    public MyItemRecyclerViewAdapter(List<Juego> items, SecondFragment secondFragment) {
        mValues = items;
    ...
    public ViewJuego onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        listener = (OnJuegoInteractionListener) secondFragment;
    ...
    public class ViewJuego extends RecyclerView.ViewHolder {
        ...
        public Juego mItem;
        public FloatingActionButton bFlotanteInsertar;
        ...
        public ViewJuego(View vista){
            ...
            imageViewEditarJuego.setOnClickListener(
                    (editar)->{
                        listener.onJuegoEditarClick(mItem);
                    }
            );

            imageViewBorrarJuego.setOnClickListener(
                    (borrar)->{
                        listener.onJuegoBorrarClick(mItem);
                    }
            );
        }
    }
